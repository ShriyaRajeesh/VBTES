...
export default function ManageRoutes() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (routes.find(r => r._id === currentRoute._id)) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-[#0f0f0f] border border-[#42f5e6] rounded-lg p-6 w-full max-w-md">
            <h3 className="text-xl font-bold text-[#42f5e6] mb-4">
              {routes.find(r => r._id === currentRoute._id) ? 'Edit Route' : 'Add New Route'}
            </h3>
            ...
            <form onSubmit={handleSubmit}>
              {!routes.find(r => r._id === currentRoute._id) && (
                <div className="mb-4">
                  <label className="block text-white mb-2">Route ID</label>
                  <input
                    type="text"
              ...
              <div className="mb-4">
                ...
                <div className="flex mb-2">
                  ...
                  <button
                    ...
                    className="bg-[#42f5e6] text-black px-4 py-2 rounded hover:bg-[#35d9cb]"
                  >
                    Add
                  </button>
                </div>
              ...
              <div className="flex justify-end gap-2">
                <button
                  type="button"
                  onClick={resetForm}
                  className="border border-[#42f5e6] text-[#42f5e6] px-4 py-2 rounded hover:bg-[#42f5e6] hover:text-black"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="bg-[#42f5e6] text-black px-4 py-2 rounded hover:bg-[#35d9cb]"
                >
                  {routes.find(r => r._id === currentRoute._id) ? 'Update' : 'Save'}
                </button>
              </div>
            </form>
          </div>
